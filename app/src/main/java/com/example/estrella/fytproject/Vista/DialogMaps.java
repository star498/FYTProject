...
import com.example.estrella.fytproject.Interactor.GetDirectionsData;
import com.example.estrella.fytproject.Interactor.GetNearbyPlacesData;
...
public class DialogMaps extends DialogFragment implements View.OnClickListener , OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container, Bundle savedInstanceState){
        View vista = inflater.inflate(R.layout.dialog_maps, null);
        search=( Button)vista.findViewById(R.id.B_search);
        to=(Button)vista.findViewById(R.id.B_to);
       tf_location = (EditText) vista.findViewById(R.id.TF_location);
